...
<head>
    ...
    <c:set var="UserLogin"  value="${administrateur.pseudo}" scope="application"/>
    <c:if test="${administrateur.pseudo==null}">
        <c:out value="${UserLog}">
        </c:out>
    </c:if>
</head>
<section class=" d-block bg-light m-4  p-2">
    ...
    <form:form action="" method="POST" modelAttribute="administrateur">
